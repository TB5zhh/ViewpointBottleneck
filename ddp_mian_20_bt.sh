...
DATAPATH=/home/aidrive1/workspace/luoly/dataset/Min_scan/eff_20/train
...
PRETRAIN="/home/aidrive1/workspace/luoly/dataset/Min_scan/bt_train/log/8W_1024/weights.pth" # For finetuning, use the checkpoint path here.
MODEL=Res16UNet34C
BATCH_SIZE=${BATCH_SIZE:-8}
TIME=$(date +"%Y-%m-%d_%H-%M-%S")
LOG_DIR=/home/aidrive1/workspace/luoly/dataset/Min_scan/bt_train/20_bt/1024/tmp_dir_scannet
mkdir -p $LOG_DIR

...
DATAPATH=/home/aidrive1/workspace/luoly/dataset/LR/unc/1/new_unc_train/train
...
PRETRAIN="/home/aidrive1/workspace/luoly/dataset/LR/unc/1/log/new_full/tmp_dir_scannet/weights.pth" # For finetuning, use the checkpoint path here.
MODEL=Res16UNet34C
BATCH_SIZE=${BATCH_SIZE:-6}
TIME=$(date +"%Y-%m-%d_%H-%M-%S")
LOG_DIR=/home/aidrive1/workspace/luoly/dataset/LR/unc/1/log/new_full/tmp_dir_scannet
mkdir -p $LOG_DIR

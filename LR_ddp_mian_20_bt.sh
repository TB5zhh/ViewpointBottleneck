...
DATAPATH=/home/aidrive1/workspace/luoly/dataset/LR/unc/20/new_unc_train/train
...
LOG_DIR=/home/aidrive1/workspace/luoly/dataset/LR/unc/20/log/new_full/tmp_dir_scannet
mkdir -p $LOG_DIR
